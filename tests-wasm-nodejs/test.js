...
var fs = require('fs');
var babycat = require('../target/wasm/nodejs/babycat.js');

const AUDIO_FOR_TESTS_DIR = __dirname + '/../audio-for-tests/';

const COF = fs.readFileSync(AUDIO_FOR_TESTS_DIR + 'circus-of-freaks/track.mp3');
...
describe('FloatWaveform.fromFramesOfSilence', function() {
    it('should work', function() {
        let waveform = babycat.FloatWaveform.fromFramesOfSilence(
            44100, 2, 1000
        );
...
describe('FloatWaveform.fromMillisecondsOfSilence', function() {
    it('should work', function() {
        let waveform = babycat.FloatWaveform.fromMillisecondsOfSilence(
            44100, 2, 10000
        );
...
describe('FloatWaveform.fromEncodedArray', function() {
    ...
    it('test_circus_of_freaks_default_1', function() {
        let decodeArgs = {};
        let waveform = babycat.FloatWaveform.fromEncodedArray(COF, decodeArgs);
        assertWaveform(waveform, COF_NUM_CHANNELS, COF_NUM_FRAMES, COF_FRAME_RATE_HZ);
    });
    ...
    it('test_circus_of_freaks_wrong_time_offset_1', function() {
        ...
        assert.throws(() => babycat.FloatWaveform.fromEncodedArray(COF, decodeArgs));
    });
